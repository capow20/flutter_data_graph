...
function getSelectedTag(event, canvas, tags) {
...
function displayTooltipOnMouseMove(e, g2, config) {
  let [xMin, xMax] = g2.xAxisRange();
  var tag = getSelectedTag(e, g2.canvas_, config.tags.filter((e2) => xMin <= e2.xValue && e2.xValue <= xMax));
    ...
    interactionModel: {
      ...
      mousemove(e, g2, ctx) {
        try {
          ...
          displayTooltipOnMouseMove(e, g2, config);
        } catch (_) {
        }
      }
    },
